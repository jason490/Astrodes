...
void Player::_bind_methods() {
    ClassDB::bind_method(D_METHOD("get_amplitude"), &Player::get_amplitude);
...
void Player::set_amplitude(const double p_amplitude) { amplitude = p_amplitude; }

double Player::get_amplitude() const { return amplitude; }
